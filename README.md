...
The Voronoi region is the region around a cluster center where points are closest to that cluster center, in the image below the borders of the Voronoi regions are marked by solid lines.
